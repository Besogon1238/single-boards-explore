...
Я буду очень благодарен любым комментариям, замечаниям и дополнениям к моим заметкам, которые будут публиковаться здесь...иии вскоре где нибудь, где это сможет прочесть любой. Принимаю любые косяки и недочеты, как по содержанию, так и по форме :)
...
[[Файл:Джампер на переходнике.jpg|мини|Положение джампера 3.3 V]]
...
[[Файл:Запуск в IDE.png|альт=Запуск прямо из IDE|мини|762x762пкс|Запуск прямо из IDE]]
