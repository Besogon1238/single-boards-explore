...
А вот теперь ключевой момент. После того как start.elf сделал свою работу, ему нужно передать управление ядру Linux. Но откуда он знает, какое именно ядро запускать и с какими параметрами?
